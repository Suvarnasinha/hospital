...
const { registration, login, logout, logoutalltheuser } = require('../controller/registration');
...
router.post("/reminder", generateReminders);
// router.post("/report", reportgenrator);
router.post("/report", upload.single('file'), reportgenrator);
